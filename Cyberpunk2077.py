...
def setup_game():
    ...
    print(" Bien alors, placons les choses aujourd'hui nous ne sommes pas le \n " + time.strftime(
        '%D %m %A') + " mais bien le 21 septembre 2077 ")
    time.sleep(0.05)
    print(
        " Tant de temps est passé nous t'attendions " + player1.name + " tu sais. Ce n'est pas facile après tout ce qu'il s'est passé. ")
    time.sleep(0.05)
